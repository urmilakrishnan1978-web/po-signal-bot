...
async def do_signal(session, sym, cid):
    ...
    if d["ok"]:
        # Send main signal
        await send_msg(session, fmt(d), cid)
        # Send countdown message
        arrow = "⬆️ CALL — BUY 🟢" if d["is_up"] else "⬇️ PUT — SELL 🔴"
        countdown_msg = f"""⏳ <b>NEXT CANDLE COUNTDOWN</b> ⏳
━━━━━━━━━━━━━━━━━━━━
📊 <b>{sym}</b>
{arrow}
━━━━━━━━━━━━━━━━━━━━
🕐 <b>60 seconds</b> mein next candle
🕐 <b>45 seconds</b> — Ready raho
🕐 <b>15 seconds</b> — Entry lo!
━━━━━━━━━━━━━━━━━━━━
⚠️ <i>Candle close hone se 5-10 sec pehle entry lein</i>
🤖 @Traders_New_AI_Bot"""
        await send_msg(session, countdown_msg, cid)
        # Wait 45 seconds then send entry alert
        await asyncio.sleep(45)
        entry_msg = f"""⚡ <b>ENTRY ALERT!</b> ⚡
━━━━━━━━━━━━━━━━━━━━
📊 <b>{sym}</b>
{arrow}
━━━━━━━━━━━━━━━━━━━━
🔴 <b>15 SECONDS MEIN ENTRY LO!</b>
━━━━━━━━━━━━━━━━━━━━
✅ Abhi Pocket Option mein jao
✅ Trade button dabao
⚠️ <i>5-10 sec pehle entry lein</i>
🤖 @Traders_New_AI_Bot"""
        await send_msg(session, entry_msg, cid)
    else:
        await send_msg(session, f"❌ {sym} signal nahi mila — dobara try karein", cid)
